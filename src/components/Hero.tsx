                ...
                <div className="flex flex-col md:flex-row md:items-center">
                    <div className="md:w-1/2 md:pr-12 mb-10 md:mb-0">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                            IT Solutions for <span className="bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent">Modern</span> Businesses
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <button
                                ...
                                className="border border-gray-600 text-gray-300 px-6 py-3 rounded-lg hover:bg-gray-800/50 transition-colors font-medium"
                            >
                                Contact Us
                            </button>
                        </div>
                    ...
                    <div className="md:w-1/2">
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-teal-500/20 rounded-full z-0"></div>
                            <div className="relative z-10 bg-gray-900/50 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden">
                                <Image
